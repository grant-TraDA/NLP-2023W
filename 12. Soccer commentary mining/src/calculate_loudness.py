...
from src.emotion_recognition import save_results_to_csv
...
def calculate_loudness(file_path, interval_samples=16_000, sample_rate=16000):
    ...
    for start_samples in range(0, len(audio), interval_samples):
        ...
        result = {"start_frame": start_samples, "end_frame": end_samples, "dBFS": chunk.dBFS}
...
if __name__ == "__main__":
    ...
    base_directory = Path('./../data/audio/france_ligue-1/2014-2015/2015-04-05 - 22-00 Marseille 2 - 3 Paris SG')  # Base directory containing audio files
    output_directory = Path('./../data/loudness')  # Directory to save the CSV file
